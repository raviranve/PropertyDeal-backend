...
router.put("/category/:categoryId/subcategories/:subIndex", controller.updateSubCategory);
router.delete("/category/:categoryId/subcategories/:subIndex", controller.deleteSubCategory);
